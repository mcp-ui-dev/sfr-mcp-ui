...
export const MCPServerManager = ({
  ...
  const generateServerFromUrl = (url: string): MCPServer | null => {
    ...
    const newUrl = ["https://mcpstorefront.com", owner, repo]
      .filter(Boolean)
      .join("/");
            ...
            <div className="space-y-4">
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  placeholder="https://mcpstorefront.com/microsoft/playwright-mcp"
                  className="relative z-0 placeholder:text-muted-foreground/60"
                />
                <p className="text-xs text-muted-foreground/80">
                  A mcpstorefront.com server, a github.com repository, or a
